...
public class CustomerConfig {
	...
	CommandLineRunner commandLineRunner(CustomerRepository customerRepository ) {
		...
		michael.getAddress().add(mike);
			...
			Address bless = new Address ("Testing","Test","Midrand", "England", "London");
			bless.setCustomer(blessing);

			Address bless1 = new Address ("Testing","Test","Midrand", "England", "London");
			bless1.setCustomer(blessing);

			Address bless2 = new Address ("Testing","Test","Midrand", "England", "London");
